...
fetchd init node0 --chain-id testnet_9002-1 --home data/node0
fetchd init node1 --chain-id testnet_9002-1 --home data/node1
fetchd init node2 --chain-id testnet_9002-1 --home data/node2
...
fetchd gentx  node1 100000000000000000000afet --home data/node0  --node-id $(fetchd tendermint show-node-id --home data/node0) --chain-id testnet_9002-1
fetchd gentx  node2  100000000000000000000afet --home data/node1  --node-id $(fetchd tendermint show-node-id --home data/node1) --chain-id testnet_9002-1
fetchd gentx  node3 100000000000000000000afet --home data/node2  --node-id $(fetchd tendermint show-node-id --home data/node2) --chain-id testnet_9002-1

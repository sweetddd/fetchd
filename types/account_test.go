...
import (
	...
	cryptocodec "github.com/fetchai/fetchd/crypto/codec"
	"github.com/fetchai/fetchd/crypto/ethsecp256k1"
	ethermintcodec "github.com/fetchai/fetchd/encoding/codec"
